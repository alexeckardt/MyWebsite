...
export const WorkExperience = () => {
    return (
        <div className="w-11/12 lg:w-7/12 max-w-[1800px] flex flex-col items-start text-start justify-start p-8 gap-y-4">
            ...
            <WorkExperienceItem company={"McMaster University"} title={"Teaching Assistant"} iconClass={"w-12 h-12 bg-[url(/images/work/mcmaster.jpg)] bg-cover rounded-xl"} year={2024}>
                <div className="font-funnel dark:text-royal-300 mb-1">
