    ...
    return (
        <div className='relative w-full flex flex-col items-center'>
            ...
            <div className="inline mt-5 mx-20 lg:mx-0">
                <div className="font-funnel text-2xl text-black dark:text-white lg:-ml-4 mb-4 lg:mb-2">Hi, I'm</div>
            ...
            <div className="w-11/12 lg:w-7/12 flex items-center justify-center flex-col text-center max-w-[1800px] p-5 font-funnel text-lg mt-2 mb-3 text-royal-900 dark:text-royal-400">
                <div className="mb-4">I'm a Software Engineer and a NewGrad Computer Science Student.</div>
